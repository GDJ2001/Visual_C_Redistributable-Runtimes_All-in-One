...
How to use
1. Place this batch file in the same folder as the redistributable EXEs.

3. Run the script:
   - Double-click the batch — it will start automatically 

Optional: If you have ideas, Commit to Git
  * GitHub username (GDJ2001).